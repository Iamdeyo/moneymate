...
const GetStarted = () => {
  return (
    <div className="flex flex-col h-screen bg-darkslateblue items-center text-white min-h-[800px] relative">
      ...
      <div className="flex items-center justify-end w-full absolute bottom-20 left-0">
        <Link
          href={"/signup"}
